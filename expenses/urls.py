...
urlpatterns = [
    ...
    path('budget/login/logout/', logout_view, name='logout'),
    path('budget/login/profile/', profile_view, name='profile'),
    path('budget/login/register/', register_view, name='register'),
